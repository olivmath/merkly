...
var web3_utils_2 = require("web3-utils");
Object.defineProperty(exports, "isContractInitOptions", { enumerable: true, get: function () { return web3_utils_2.isContractInitOptions; } });
const isWeb3ContractContext = (options) => typeof options === 'object' && !(0, web3_utils_1.isNullish)(options) &&
    Object.keys(options).length !== 0 && !(0, web3_utils_1.isContractInitOptions)(options);
